...
/**
 * @brief Internal helper macro to declare an element descriptor
 *
 * @param struct_ Struct packing the values
 ...
 */
#define JSON_ELEMENT_DESCR(struct_, len_field_, elem_type_, union_) \
	(struct json_obj_descr[]) \
	{ \
		{ \
			.align_shift = Z_ALIGN_SHIFT(struct_), \
...
/**
 * @brief Internal helper macro to declare an array descriptor
 *
 ...
 */
#define JSON_DESCR_ARRAY(elem_descr_, elem_descr_len_) \
	{ \
		.array = { \
...
/**
 * @brief Internal helper macro to declare an object descriptor
 *
 * @param elem_descr_ Element descriptor, pointer to a descriptor array
 * @param elem_descr_len_ Number of elements in elem_descr_
 */
#define JSON_DESCR_OBJ(elem_descr_, elem_descr_len_) \
	{ \
		.object = { \
...
#define JSON_OBJ_DESCR_ARRAY(struct_, field_name_, max_len_, \
	...
	{ \
		...
		{ \
			.array = { \
				.element_descr = JSON_ELEMENT_DESCR(struct_, len_field_, \
					elem_type_,), \
				.n_elements = (max_len_), \
			}, \
		}, \
	...
	{ \
		...
		{ \
			.array = { \
				.element_descr = JSON_ELEMENT_DESCR(struct_, len_field_, \
					JSON_TOK_OBJECT_START, \
					JSON_DESCR_OBJ(elem_descr_, elem_descr_len_)), \
				.n_elements = (max_len_), \
			}, \
		}, \
	}
...
#define JSON_OBJ_DESCR_ARRAY_NAMED(struct_, json_field_name_,\
	...
	{ \
		...
		{ \
			.array = { \
				.element_descr = \
					JSON_ELEMENT_DESCR(struct_, len_field_, elem_type_,), \
				.n_elements = (max_len_), \
			}, \
		}, \
	}
	...
	{ \
		...
		{ \
			.array = { \
				.element_descr =  JSON_ELEMENT_DESCR(struct_, len_field_, \
					JSON_TOK_OBJECT_START, \
					JSON_DESCR_OBJECT(elem_descr_, elem_descr_len_)), \
				.n_elements = (max_len_), \
			}, \
		}, \
	}
